...
@include('navbar')
@section ('content')
<div class="row p-4 overflow-auto">
  <div class="col-1 ms-5 me-2">
    <div class="row">
      <a class="btn btn-round btn-outline-dark btn-floating mb-3 p-2">
  ...
  <div class="col-4 ms-5">
    <div class="row">
      <h1 class="fw-bold display-5 title" id="heading1">How do you design content for every language</h1>
    </div>
    <div class="row my-3">
    ...
    <div class="row">
      <a class="btn btn-circle btn-outline-light rounded-circle btn-floating ms-2 mb-3 text-black py-4">Scroll</a>
    </div>
  </div>

  <div class="col-5 mt-auto ms-auto end">
  ...
  <div class="row">
    <div class="col-8 background filtered bg-image text-white p-5">
      <div class="col-6 ms-5 mt-5 mb-2">
        <h2 id="heading2" class="h3 mb-2">Delighting customers in over 200 cities in the world.</h2>
  ...
  <div class="row background-grey pt-5">
    <div class="col pb-3 px-5">
      <div class="col-6 mx-auto">
        <div class="row mb-4">
          <h2 class="title" id="heading3" >Our Expertises</h2>
        </div>
        <div class="row">
